...
function TeacherLayoutContent({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50" dir={direction}>
      <header className="lg:hidden bg-white border-b px-4 py-3 flex items-center justify-between relative z-40">
        ...
        {mobileOpen && (
          <div className="absolute left-0 right-0 top-full bg-white border-b shadow-lg p-3 space-y-1 z-50">
            {navItems.map((item) => {
