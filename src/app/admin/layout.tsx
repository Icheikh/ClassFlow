...
function AdminLayoutContent({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex" dir={direction}>
      ...
      <aside className={cn("hidden lg:flex w-64 bg-white shadow-sm flex flex-col shrink-0", isRtl ? "border-l" : "border-r")}>
      ...
      <main className="flex-1 px-4 py-8 pt-20 lg:px-8 lg:pt-8 overflow-y-auto">
        {children}
      </main>
    </div>
  )
