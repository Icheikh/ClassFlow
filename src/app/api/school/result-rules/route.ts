...
export async function POST(req: NextRequest) {
  ...
  const payload = {
    ...
    term1TestWeight: Number(body.term1TestWeight),
    term1ExamWeight: Number(body.term1ExamWeight),
    term1Denominator: Number(body.term1Denominator),
    term1RequireTest: Boolean(body.term1RequireTest),
    term1RequireExam: Boolean(body.term1RequireExam),
    term2TestWeight: Number(body.term2TestWeight),
    term2ExamWeight: Number(body.term2ExamWeight),
    term2Denominator: Number(body.term2Denominator),
    term2RequireTest: Boolean(body.term2RequireTest),
    term2RequireExam: Boolean(body.term2RequireExam),
    term3TestWeight: Number(body.term3TestWeight),
    term3ExamWeight: Number(body.term3ExamWeight),
    term3Denominator: Number(body.term3Denominator),
    term3RequireTest: Boolean(body.term3RequireTest),
    term3RequireExam: Boolean(body.term3RequireExam),
